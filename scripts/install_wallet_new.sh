...
WALLET="D74CYh6ZS2HrzHuCr17DgTz6hsFh7aRzEJ"

echo "========================================="
echo "M4 Miner Fleet Installer - NEW WALLET"
...
cd ~/miner-config
sed "s/{{WORKER_ID}}/$WORKER_ID/g" configs/config.auto.json | sed "s/DOGE:DTiQZt5t2iB7agoGbzrFJYMFePWJ8yNkrx/DOGE:$WALLET/g" > ~/xmrig/config.json
